...
> **Mental Model:** Think of an epidemic not just as a biological process, but as a dynamic process flowing through a network. The structure of this network fundamentally dictates the speed and reach of the spread.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_various.png)](/../../../assets/posts/gatech/network_science/L9_various.png)
...
#### Other Spreading Processes on Networks
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_otherspread.png)](/../../../assets/posts/gatech/network_science/L9_otherspread.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_otherspread1.png)](/../../../assets/posts/gatech/network_science/L9_otherspread1.png)
...
### SI Model
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_SIModel.png)](/../../../assets/posts/gatech/network_science/L9_SIModel.png) _Figure 10.5 from Network Science by Albert-László Barabási_

Suppose that we have $N$ individuals in the population and, according to the **homogeneous mixing assumption**, each individual has the same number of contacts $\bar{k}$ (this is shown as  in the textbook visualizations).
...
### SIS Model
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_SISModel.png)](/../../../assets/posts/gatech/network_science/L9_SISModel.png) _Figure 10.5 from Network Science by Albert-László Barabási_
...
> **Mental Model:** Long-range ties in small-world networks exponentially decrease the average path length, enabling rapid decentralized search.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_SIRModel.png)](/../../../assets/posts/gatech/network_science/L9_SIRModel.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_SIRModel1.png)](/../../../assets/posts/gatech/network_science/L9_SIRModel1.png) _Figure 10.6 from Network Science by Albert-László Barabási_
...
> **Key Concept:** The reproductive number ($R_0$) represents the average number of secondary infections caused by one infected individual.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_compare.jpeg)](/../../../assets/posts/gatech/network_science/L9_compare.jpeg) _Figure 10.7 from Network Science by Albert-László Barabási_
...
### Number of Partners in Sexual Networks
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_numbers.jpeg)](/../../../assets/posts/gatech/network_science/L9_numbers.jpeg) _Figure 10.13 from Network Science by Albert-László Barabási_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_numbers1.jpeg)](/../../../assets/posts/gatech/network_science/L9_numbers1.jpeg) _Figure 10.14 from Network Science by Albert-László Barabási_
...
### Number of “Close Proximity” Contacts
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_close_prox.jpeg)](/../../../assets/posts/gatech/network_science/L9_close_prox.jpeg) _Figure 10.16 from Network Science by Albert-László Barabási_
...
> **Mental Model:** Social influence often requires a critical mass of adoption among neighbors before an individual changes their state.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_global.jpeg)](/../../../assets/posts/gatech/network_science/L9_global.jpeg)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_global1.jpeg)](/../../../assets/posts/gatech/network_science/L9_global1.jpeg) _Figure 10.15 from Network Science by Albert-László Barabási_
...
### Reproductive Number R0
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_R0.png)](/../../../assets/posts/gatech/network_science/L9_R0.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_R0_table.png)](/../../../assets/posts/gatech/network_science/L9_R0_table.png) _Figure 10.15 from Network Science by Albert-László Barabási_
...
> **Key Concept:** The epidemic threshold determines whether a disease dies out or becomes an **endemic state** in the population.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_fallacy.png)](/../../../assets/posts/gatech/network_science/L9_fallacy.png) _Image Source: Super-spreaders in infectious diseases[Richard A.Stein (Links to an external site.)](https://www.sciencedirect.com/science/article/pii/S1201971211000245), International Journal of Infectious Diseases, August 2011._
...
#### **Superspreaders** in Various Epidemics
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_fallacy_table.png)](/../../../assets/posts/gatech/network_science/L9_fallacy_table.png) _[Table Source: Cellular **Superspreaders**: An Epidemiological Perspective on HIV Infection inside the Body](https://doi.org/10.1371/journal.ppat.1004092%C2%A0).Kristina Talbert-Slagle et al., 2014,_
...
### Degree Block Approximation
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_degree_block.jpeg)](/../../../assets/posts/gatech/network_science/L9_degree_block.jpeg) _Figure 10.19 from Network Science by Albert-László Barabási_
...
### SIS Model – With An Arbitrary Degree Distribution
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_revisit_SIS.png)](/../../../assets/posts/gatech/network_science/L9_revisit_SIS.png) _Figure 9.29 from Network Science by Albert-László Barabási_
...
\\[\frac{\beta}{\bar{k}}\sum_kk^2\,p_k\,\theta(t)-\frac{\beta}{\bar{k}}\sum_kk\,p_k\,\theta(t)-\frac{\mu}{\bar{k}}\sum_k(k-1)\,p_k\,i_k(t)=\\] \\[\frac{\beta}{\bar{k}}\sum_kk^2\,p_k\,\theta(t)-\frac{\beta}{\bar{k}}\sum_kk\,p_k\,\theta(t)-\frac{\mu}{\bar{k}}\sum_k(k-1)\,p_k\,i_k(t)=\\] \\[= (\frac{\beta \, \bar{k^2}}{\bar{k}} - (\beta+\mu)) \, \theta(t)\\]
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_revisit_SIS1.jpeg)](/../../../assets/posts/gatech/network_science/L9_revisit_SIS1.jpeg) _Figure 10.11 from Network Science by Albert-László Barabási_
...
> **Mental Model:** Hubs act as super-spreaders. Removing them can fragment the network, but they also accelerate contagion.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_summary_SISR.png)](/../../../assets/posts/gatech/network_science/L9_summary_SISR.png)
...
### Computational Modeling of Epidemics
#### Epidemic Models in Practice
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_computational.png)](/../../../assets/posts/gatech/network_science/L9_computational.png)
...
> **Key Concept:** Homogeneous mixing is a simplifying assumption that often fails in real-world networks with high degree variance.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_computational1.png)](/../../../assets/posts/gatech/network_science/L9_computational1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_computational2.png)](/../../../assets/posts/gatech/network_science/L9_computational2.png)
...
> **Mental Model:** Networks are not static structures; they are dynamic pathways for information, pathogens, and influence.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_computational3.png)](/../../../assets/posts/gatech/network_science/L9_computational3.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L9_effective.jpeg)](/../../../assets/posts/gatech/network_science/L9_effective.jpeg) _Figure 10.32 from Network Science by Albert-László Barabási_
...
## Chapter Summary
This chapter summarized the key concepts and models associated with the topics outlined above.
