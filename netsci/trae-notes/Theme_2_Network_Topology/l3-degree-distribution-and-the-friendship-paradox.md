...
> **Key Concept:** The degree distribution defines the fundamental topology of a network. By representing the probability that a randomly chosen node has degree $k$, it provides a statistical snapshot of connectivity, differentiating random graphs from real-world scale-free networks.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_degree_distribution.png)](/../../../assets/posts/gatech/network_science/L3_degree_distribution.png)
...
> **Mental Model:** Think of moments as summarizing the "shape" of the degree distribution. The first moment gives the average degree, while the second moment and variance tell us how widely degrees vary around that average.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_DDM1.png)](/../../../assets/posts/gatech/network_science/L3_DDM1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_DDM2.png)](/../../../assets/posts/gatech/network_science/L3_DDM2.png)
...
> **Key Concept:** Exponential distributions indicate a typical scale (most nodes have similar degrees), while power-law distributions are scale-free, meaning they lack a typical scale and naturally feature massive hubs.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_TSDD.png)](/../../../assets/posts/gatech/network_science/L3_TSDD.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_sex_contact.png)](/../../../assets/posts/gatech/network_science/L3_sex_contact.png)
...
> **Mental Model:** The friendship paradox arises because high-degree nodes (hubs) are overrepresented when we sample by edges rather than by nodes. You are more likely to be friends with someone who has many friends!
...
Suppose that we pick a random edge in the network – and we randomly select one of the two end-points of that edge – _we refer to those end-points as the**stubs** of the edge._ What is the probability $q_k$ that a randomly chosen stub belongs to a node of degree k?
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_friends.png)](/../../../assets/posts/gatech/network_science/L3_friends.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_friends2.png)](/../../../assets/posts/gatech/network_science/L3_friends2.png)
...
> **Key Concept:** By immunizing the *contacts* of random individuals rather than the individuals themselves, we exploit the friendship paradox to disproportionately target hubs, which are critical to stopping the spread of disease.
...
> **Mental Model:** In a G(n,p) random network, degrees are tightly clustered around the mean. The probability of finding a node with a degree significantly higher than the average decays faster than exponentially.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_dist.png)](/../../../assets/posts/gatech/network_science/L3_dist.png)
...
> **Key Concept:** A **phase transition** occurs in G(n,p) graphs when the average degree exceeds $\bar{k} = 1$. At this critical point, a giant component emerges, rapidly incorporating a large fraction of the network's nodes.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_lcc1.png)](/../../../assets/posts/gatech/network_science/L3_lcc1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_lcc2.png)](/../../../assets/posts/gatech/network_science/L3_lcc2.png)
...
> **Mental Model:** Degree correlation measures whether nodes prefer to connect to others with similar degrees (assortative) or dissimilar degrees (disassortative). Neutral networks show no preference.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_DC1.png)](/../../../assets/posts/gatech/network_science/L3_DC1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_DC2.png)](/../../../assets/posts/gatech/network_science/L3_DC2.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L3_ANDN.png)](/../../../assets/posts/gatech/network_science/L3_ANDN.png)
