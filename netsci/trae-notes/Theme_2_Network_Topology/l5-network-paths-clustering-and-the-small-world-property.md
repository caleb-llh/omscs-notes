...
> **Key Concept:** The clustering coefficient measures the degree to which nodes in a graph tend to cluster together. In social networks, it quantifies the probability that two of your friends are also friends with each other.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_cluster.jpeg)](/../../../assets/posts/gatech/network_science/L5_cluster.jpeg)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_cluster1.jpeg)](/../../../assets/posts/gatech/network_science/L5_cluster1.jpeg)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_avg_cluster.jpeg)](/../../../assets/posts/gatech/network_science/L5_avg_cluster.jpeg)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_weighted.jpeg)](/../../../assets/posts/gatech/network_science/L5_weighted.jpeg) _Comparison of weighted and unweighted clustering coefficient for an example graph._
...
> **Mental Model:** Random G(n,p) networks lack structure. As the network size grows, the probability of forming triangles drops, leading to negligible clustering. Real networks behave very differently!
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_cluster_gnp.jpeg)](/../../../assets/posts/gatech/network_science/L5_cluster_gnp.jpeg) _Figure 3-13 from networksciencebook.com_
...
> **Key Concept:** The Characteristic Path Length (CPL) is the average shortest path distance between all pairs of nodes. It measures the network's global efficiency for spreading information.
...
|   
---|---  
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_characteristics1.png)](/../../../assets/posts/gatech/network_science/L5_characteristics1.png) | [![image](https://lowyx.com/assets/posts/gatech/network_science/L5_characteristics2.png)](/../../../assets/posts/gatech/network_science/L5_characteristics2.png)  
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_diameter1.jpeg)](/../../../assets/posts/gatech/network_science/L5_diameter1.jpeg)
...
Even though this expression is a very rough approximation, it shows something remarkable: in a random network, even the longest shortest—paths are expected to grow very slowly (i.e., _logarithmically_) with the size of the network.
...
Specifically, for very sparse networks, as k approaches to 1 from above (_so that the network is still expected to have a large connected component_), the diameter is expected to be
...
>   * Go back to the example of the previous page (_a social network with 7 billion nodes and an average degree of 64_). What would be the diameter according to either of the previous two approximations?
> 
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_diameter_efficiency.png)](/../../../assets/posts/gatech/network_science/L5_diameter_efficiency.png)
...
> **Mental Model:** A small-world network perfectly balances the high clustering of regular lattices with the short path lengths of random graphs. Most real-world networks exhibit this dual nature!
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_smallnetwork1.png)](/../../../assets/posts/gatech/network_science/L5_smallnetwork1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_smallnetwork2.png)](/../../../assets/posts/gatech/network_science/L5_smallnetwork2.png)
...
> **Key Concept:** By randomly rewiring just a small fraction of edges in a highly clustered regular lattice, the Watts-Strogatz model creates "shortcuts" that drastically reduce the average path length, forming a small-world network.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_smallnetwork3.png)](/../../../assets/posts/gatech/network_science/L5_smallnetwork3.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_smallnetwork4.png)](/../../../assets/posts/gatech/network_science/L5_smallnetwork4.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_clustering_pa1.jpeg)](/../../../assets/posts/gatech/network_science/L5_clustering_pa1.jpeg)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_clustering_pa2.jpeg)](/../../../assets/posts/gatech/network_science/L5_clustering_pa2.jpeg)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_shortest_pa.jpeg)](/../../../assets/posts/gatech/network_science/L5_shortest_pa.jpeg)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_path_lengths.jpeg)](/../../../assets/posts/gatech/network_science/L5_path_lengths.jpeg)
...
> **Key Concept:** Beyond simple triangles in undirected graphs, directed networks feature 13 distinct 3-node connectivity patterns. These are the basic building blocks, or "motifs," of complex directed networks.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_directed_subraph.png)](/../../../assets/posts/gatech/network_science/L5_directed_subraph.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_statistical_test.jpeg)](/../../../assets/posts/gatech/network_science/L5_statistical_test.jpeg)
...
> **Mental Model:** If a specific motif (like a FeedForward Loop) appears significantly more often than chance would predict, it likely serves a crucial evolutionary or engineered function in the system, much like a specific logic gate in a circuit.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_motifs.png)](/../../../assets/posts/gatech/network_science/L5_motifs.png)

Most real-world networks are either designed by humans (_such as electronic circuits or communication networks_) or they evolve naturally (such as biological or social networks) to perform certain functions.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L5_motifs1.png)](/../../../assets/posts/gatech/network_science/L5_motifs1.png)
