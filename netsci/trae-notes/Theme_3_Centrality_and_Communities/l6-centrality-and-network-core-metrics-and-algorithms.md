...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_DE1.png)](/../../../assets/posts/gatech/network_science/L6_DE1.png)

> **Key Concept:** **Degree centrality** measures the local importance of a node based on its direct connections. In directed networks, this splits into in-degree and out-degree.
...
Another issue with this centrality metric is that it is easy to manipulate locally. Back in the early days of the Web, some search engines used to rank results based on **degree centrality** (_how many other Web pages point to that page_). Some online firms quickly exploited that vulnerability: they would create 1000s of links from fake web pages so that they boost the centrality/rank of their sponsored web sites.

* * *

####  **Eigenvector Centrality**
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_DE2.png)](/../../../assets/posts/gatech/network_science/L6_DE2.png)

> **Mental Model:** Think of **Eigenvector Centrality** as a recursive popularity contest: your importance is determined by the importance of the people you know.
...
####  The **Katz Centrality**
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_DE3.png)](/../../../assets/posts/gatech/network_science/L6_DE3.png)

> **Key Concept:** **Katz centrality** resolves the issue of zero in-degree nodes in directed networks by assigning a baseline centrality ($\beta$) to every node.
...
###  **PageRank** Centrality
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_pagerank.png)](/../../../assets/posts/gatech/network_science/L6_pagerank.png)
...
> **Mental Model:** **PageRank** is **Katz centrality** with a twist: a node's "wealth" or centrality is divided equally among its outgoing links, preventing a single node from unduly inflating the centrality of all its neighbors.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_closeness.png)](/../../../assets/posts/gatech/network_science/L6_closeness.png)
...
####  **Harmonic Centrality**
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_closeness2.png)](/../../../assets/posts/gatech/network_science/L6_closeness2.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_between.png)](/../../../assets/posts/gatech/network_science/L6_between.png)
...
> **Key Concept:** Betweenness centrality quantifies a node's role as a bridge or bottleneck. Nodes with high betweenness are critical for flow across the network, even if their degree is low.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_between1.png)](/../../../assets/posts/gatech/network_science/L6_between1.png)
...
###  **Path Centrality** For Directed Acyclic Graphs
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_path_centrality.jpeg)](/../../../assets/posts/gatech/network_science/L6_path_centrality.jpeg)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_k_core.png)](/../../../assets/posts/gatech/network_science/L6_k_core.png) _(Image from research paper:[Perturb and combine to identify influential spreaders in real-world networks](https://dl.acm.org/doi/abs/10.1145/3341161.3342866),AJP Tixier, MEG Rossi, FD Malliaros, J Read )_
...
> **Mental Model:** The **k-core** decomposition peels the network like an onion, progressively removing lower-degree nodes to reveal the most densely connected core.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_core_ph.png)](/../../../assets/posts/gatech/network_science/L6_core_ph.png)
...
> **Key Concept:** The **rich-club** phenomenon occurs when high-degree nodes (hubs) are more densely interconnected with each other than would be expected by chance.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_rich.jpeg)](/../../../assets/posts/gatech/network_science/L6_rich.jpeg)
...
###  Core Set of Nodes in DAGs
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_core.jpeg)](/../../../assets/posts/gatech/network_science/L6_core.jpeg)
...
###  Applications
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_app1.png)](/../../../assets/posts/gatech/network_science/L6_app1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_app2.png)](/../../../assets/posts/gatech/network_science/L6_app2.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_app3.png)](/../../../assets/posts/gatech/network_science/L6_app3.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L6_app4.png)](/../../../assets/posts/gatech/network_science/L6_app4.png)
