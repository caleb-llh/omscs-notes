...
###  The **Graph Partitioning** Problem
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_GraphPartition.png)](/../../../assets/posts/gatech/network_science/L7_GraphPartition.png)

> **Key Concept:** **Graph partitioning** divides a network into predefined, equal-sized groups to minimize cross-edges, whereas community detection uncovers the natural, potentially uneven modular structure of the network.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_GraphPartition1.jpeg)](/../../../assets/posts/gatech/network_science/L7_GraphPartition1.jpeg) _Figure from Box 9.1 of Network Science Book by A.L.Barabási_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_community_detect.png)](/../../../assets/posts/gatech/network_science/L7_community_detect.png)
...
> **Mental Model:** A network community is like a social clique: nodes inside the community have many connections with each other, but relatively few connections to the outside world.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_community_detect1.png)](/../../../assets/posts/gatech/network_science/L7_community_detect1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_community_detect2.png)](/../../../assets/posts/gatech/network_science/L7_community_detect2.png)
...
###  Community Detection Based on Edge Centrality Metrics
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_community_detect_centrality.jpeg)](/../../../assets/posts/gatech/network_science/L7_community_detect_centrality.jpeg) _Three centrality measures that are discussed in this image (Image 9.11) from networksciencebook.com._

> **Key Concept:** Hierarchical clustering builds a **dendrogram** of the network. Divisive algorithms work top-down by removing bridging edges, while agglomerative algorithms work bottom-up by merging similar nodes.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_Agglomerative.jpeg)](/../../../assets/posts/gatech/network_science/L7_Agglomerative.jpeg) _Image 9.9 from networksciencebook.com . The Ravasz Algorithm The **agglomerative hierarchical clustering** algorithm proposed by Ravasz was designed to identify functional modules in metabolic networks, but it can be applied to arbitrary networks._
...
###  Hierarchical Clustering Approaches – Group Similarity
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_Hierarchical.jpeg)](/../../../assets/posts/gatech/network_science/L7_Hierarchical.jpeg) _Image 9.10 from networksciencebook.com Three approaches, called single, complete and average cluster similarity, are frequently used to calculate the community similarity from the node-similarity matrix xij_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_Hierarchical1.jpeg)](/../../../assets/posts/gatech/network_science/L7_Hierarchical1.jpeg) _A hierarchical tree in which any cut of the hierarchical tree offers a potentially valid partition (Image 9.15) from networksciencebook.com_
...
###  **Modularity** Metric
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_Modularity.jpeg)](/../../../assets/posts/gatech/network_science/L7_Modularity.jpeg)
...
_And, are these communities statistically significant?_

> **Mental Model:** Think of **Modularity** ($M$) as a statistical test for communities. It measures whether the number of internal edges in a community is significantly higher than what we would expect in a randomly wired network.
...
###  **Modularity** Metric- Derivation
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_Modularity_derive.jpeg)](/../../../assets/posts/gatech/network_science/L7_Modularity_derive.jpeg)
...
###  **Modularity** Metric – Selecting The Community Assignment
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_Modularity_metric.jpeg)](/../../../assets/posts/gatech/network_science/L7_Modularity_metric.jpeg) _Four partitions of a network: a) optimal partition b) suboptimal partition c) single community d) negative **modularity** (Image 9.16) from networksciencebook.com_
...
###  **Modularity** After Merging Two Communities
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_Modularity_merge.png)](/../../../assets/posts/gatech/network_science/L7_Modularity_merge.png)
...
###  Greedy **Modularity** Maximization
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_greedy.png)](/../../../assets/posts/gatech/network_science/L7_greedy.png)
...
###  **Louvain Algorithm**
> **Key Concept:** The **Louvain algorithm** is a highly efficient, greedy **modularity** maximization method that operates in two phases: local node movement and community aggregation.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_Louvain.png)](/../../../assets/posts/gatech/network_science/L7_Louvain.png) _The main steps of the **Louvain algorithm**. Each pass consists of two distinct steps. The sum of Steps I & II are called a pass. The network obtained after each pass is processed again, until no further increase of **modularity** is possible. (Modified from Image 9.37 from networksciencebook.com)_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_Modularity_resolution.jpeg)](/../../../assets/posts/gatech/network_science/L7_Modularity_resolution.jpeg) _A partition in which pairs of neighboring cliques are merged into a single community, as indicated by the dotted lines. (Image 9.34) from networksciencebook.com_
...
> **Mental Model:** The **modularity** resolution limit means that **modularity** optimization cannot "see" communities smaller than a certain threshold ($\sqrt{2L}$), often forcing small, distinct communities to be merged.
...
###  The **Modularity** Search Landscape
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_landscape.png)](/../../../assets/posts/gatech/network_science/L7_landscape.png)
...
###  Communities Within Communities
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_Communities.jpeg)](/../../../assets/posts/gatech/network_science/L7_Communities.jpeg) _A hierarchical model that generates a scale-free network with degree exponent. (Image 9.13 from networksciencebook.com)_

> **Key Concept:** Hierarchical **modularity** is evidenced by a clustering coefficient that decays inversely with the node's degree ($C(k) \propto 1/k$), indicating communities within communities.
...
A prototypical example of such a hierarchically modular architecture is illustrated in this visualization. The most elementary community is a five-node clique module (part a). _Note that the diagonal elements are also connected even though it is not very clear in the illustration._
...
###  Clustering Coefficient Versus Degree in Practice
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_ClusteringCoefficient.jpeg)](/../../../assets/posts/gatech/network_science/L7_ClusteringCoefficient.jpeg) _Hierarchy in Real Networks. (Image 9.36) from networksciencebook.com_
...
###  Hierarchical **Modularity** Through **Recursive Community Detection**
[![image](https://lowyx.com/assets/posts/gatech/network_science/L7_HierarchicalModularity.jpeg)](/../../../assets/posts/gatech/network_science/L7_HierarchicalModularity.jpeg) _The Greedy Algorithm. (Image 9.17) from networksciencebook.com_
