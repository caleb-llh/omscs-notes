...
> **Mental Model:** **Overlapping communities** recognize that real-world nodes (like people) play multiple roles and belong to several groups simultaneously.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_Overlapping.png)](/../../../assets/posts/gatech/network_science/L8_Overlapping.png) _typo: intelligence community marked as Light and Light community marked as Intelligence._
...
####  **CFinder** Algorithm
> **Key Concept:** The **CFinder** algorithm detects **overlapping communities** by finding adjacent **k-cliques** (cliques sharing k-1 nodes) and merging them into continuous components.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_CFinder.png)](/../../../assets/posts/gatech/network_science/L8_CFinder.png) _typo: The bottom right should be d and not b_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_CFinder1.png)](/../../../assets/posts/gatech/network_science/L8_CFinder1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_CFinder2.png)](/../../../assets/posts/gatech/network_science/L8_CFinder2.png)
...
###  **Critical Density Threshold** in **CFinder**
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_critical.jpeg)](/../../../assets/posts/gatech/network_science/L8_critical.jpeg) _Figure 9.22 from Network Science by Albert-László Barabási_
...
So we can ask the following question: _for a given network size n and value of k, what is the maximum density of a random network of size n so that the appearance of **k-cliques** is unlikely? Let’s call this density as the “**critical density threshold**”._
...
###  **Link Clustering Algorithm**
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_link_cluster.jpeg)](/../../../assets/posts/gatech/network_science/L8_link_cluster.jpeg) _Figure 9.23 from Network Science by Albert-László Barabási_

> **Mental Model:** Link clustering shifts the focus from nodes to edges. While a person might belong to multiple communities, a specific relationship (a link) usually belongs to just one.
...
###  Application of **Link Clustering Algorithm**
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_link_cluster_app.jpeg)](/../../../assets/posts/gatech/network_science/L8_link_cluster_app.jpeg) _Figure 9.24 from Network Science by Albert-László Barabási_
...
###  **GN Benchmark**
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_benchmark.jpg)](/../../../assets/posts/gatech/network_science/L8_benchmark.jpg) _Figure 9.25 from Network Science by Albert-László Barabási_
...
###  Community Size Distribution
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_community.jpeg)](/../../../assets/posts/gatech/network_science/L8_community.jpeg) _Figure 9.29 from Network Science by Albert-László Barabási_
...
The three plots shown here refer to three different networks _(the same datasets we have seen many times in the past – discussed in your textbook)_.
...
Even though there are major differences between the six algorithms _(we will return to this point later in this lesson)_ , they all tend to agree about the Protein Interaction network and the Scientific Collaboration network that the size distribution is heavy-tailed and it can be approximated by a power-law.
...
###  **LFR Benchmark**
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_LFR.jpeg)](/../../../assets/posts/gatech/network_science/L8_LFR.jpeg) _Figure 9.26 from Network Science by Albert-László Barabási_

> **Key Concept:** Synthetic benchmarks, like the **LFR benchmark**, are essential for evaluating community detection algorithms because they provide ground-truth communities with realistic power-law degree and size distributions.
...
###  **Normalized Mutual Information** (**NMI**) Metric
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_NMI.png)](/../../../assets/posts/gatech/network_science/L8_NMI.png) _Example: Confusion matrix with two partitions._
...
> **Mental Model:** The **Normalized Mutual Information** (**NMI**) metric is like a grading rubric for community detection: it measures how much the discovered communities overlap with the true communities, returning a score between 0 and 1.
...
###  Accuracy Comparison of Community Detection Algorithms
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_accuracy.jpeg)](/../../../assets/posts/gatech/network_science/L8_accuracy.jpeg) _Figure 9.27 from Network Science by Albert-László Barabási_
...
###  Run Time Comparisons
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_table.png)](/../../../assets/posts/gatech/network_science/L8_table.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_runtime.jpeg)](/../../../assets/posts/gatech/network_science/L8_runtime.jpeg) _Figure 9.28 from Network Science by Albert-László Barabási_
...
###  Dynamic Communities
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_dynamic.png)](/../../../assets/posts/gatech/network_science/L8_dynamic.png) _Figure 1[**Dynamic Community Detection**](https://doi.org/10.1007/978-1-4614-6170-8_383).by Cazabet R., Amblard F._

> **Key Concept:** **Dynamic community detection** tracks how communities evolve over time—growing, shrinking, merging, or splitting—across sequential network snapshots.
...
###  Dynamic Communities – Approach #1
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_dynamic1.png)](/../../../assets/posts/gatech/network_science/L8_dynamic1.png) _Figure 2[**Dynamic Community Detection**](https://doi.org/10.1007/978-1-4614-6170-8_383).by Cazabet R., Amblard F._
...
###  Dynamic Communities – Approach #2
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_dynamic2.png)](/../../../assets/posts/gatech/network_science/L8_dynamic2.png) _Figure 3[**Dynamic Community Detection**](https://doi.org/10.1007/978-1-4614-6170-8_383).by Cazabet R., Amblard F._
...
###  Dynamic Communities – Approach #3
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_dynamic3.png)](/../../../assets/posts/gatech/network_science/L8_dynamic3.png) _Figure 4[**Dynamic Community Detection**](https://doi.org/10.1007/978-1-4614-6170-8_383).by Cazabet R., Amblard F._
...
###  **Participation Coefficient**
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_Participation.png)](/../../../assets/posts/gatech/network_science/L8_Participation.png)

> **Mental Model:** The **Participation Coefficient** measures a node's diversity of connections. A node with a high **participation coefficient** is a "connector," bridging multiple communities.
...
###  **Within-module Degree**
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_within.png)](/../../../assets/posts/gatech/network_science/L8_within.png) _Figure from[Worked Example: Centrality and Community Structure of US Air Transportation Network](https://dshizuka.github.io/networkanalysis/example_usairports.html). by Dai Shizuka_
...
###  Case Study: Metabolic Networks
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_metabolic.webp)](/../../../assets/posts/gatech/network_science/L8_metabolic.webp) _Figure 3: Cartographic representation of the metabolic network of E. coli. from[Functional cartography of complex metabolic networks](https://www.nature.com/articles/nature03288). by Guimerà, R., Nunes Amaral, L._
...
###  δ-MAPS
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_delta1.png)](/../../../assets/posts/gatech/network_science/L8_delta1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_delta2.png)](/../../../assets/posts/gatech/network_science/L8_delta2.png)
...
###  δ-MAPS – Domain Homogeneity Constraint
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_delta3.png)](/../../../assets/posts/gatech/network_science/L8_delta3.png)
...
###  δ-MAPS: Algorithm Overview
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_delta4.png)](/../../../assets/posts/gatech/network_science/L8_delta4.png) _Figure from “[δ-MAPS: from spatio-temporal data to a weighted and lagged network between functional domains](https://link.springer.com/article/10.1007/s41109-018-0078-z)” by Fountalis, I., Dovrolis, C., Bracco, A. et al., 2018_
...
###  Application in Climate Science
[![image](https://lowyx.com/assets/posts/gatech/network_science/L8_climate.png)](/../../../assets/posts/gatech/network_science/L8_climate.png) _Figure from “[δ-MAPS: from spatio-temporal data to a weighted and lagged network between functional domains](https://link.springer.com/article/10.1007/s41109-018-0078-z)” by Fountalis, I., Dovrolis, C., Bracco, A. et al., 2018_
