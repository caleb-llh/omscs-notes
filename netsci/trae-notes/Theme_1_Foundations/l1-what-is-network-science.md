...
> **Key Concept:** Network Science studies complex systems by focusing on their architecture, modeling how components interconnect as a network or graph.
...
> **Mental Model:** Think of a complex system like a giant puzzle where the pieces (components) are highly specific in their connections and interact in non-linear ways.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_complex_systems.png)](/../../../assets/posts/gatech/network_science/L1_complex_systems.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_trivial_vs_complex.png)](/../../../assets/posts/gatech/network_science/L1_trivial_vs_complex.png) _Image Source:[Local Patterns to Global Architectures: Influences of Network Topology on Human Learning. Karuza, Thompson-Schill, Bassett; 2016](https://www.cell.com/trends/cognitive-sciences/fulltext/S1364-6613\(16\)30071-7)_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_brian_celegans_worm.png)](/../../../assets/posts/gatech/network_science/L1_brian_celegans_worm.png) _(Image Source:[wormwiring.org](https://wormwiring.org/))_
...
> **Key Concept:** The main premise of network science is that the **network architecture** provides valuable insights into a system's function, resilience, and evolution, even without knowing every lower-level detail.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_main_premise.png)](/../../../assets/posts/gatech/network_science/L1_main_premise.png) _Image Source:[techiereader.com](https://techiereader.com/category/networking/)_
...
> **Mental Model:** Network centrality identifies the "VIPs" of a network. Depending on the metric (e.g., **PageRank** or **Betweenness**), importance can mean being highly connected, or acting as a critical bridge between different groups.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_network_centrality1.png)](/../../../assets/posts/gatech/network_science/L1_network_centrality1.png) _Image Source:[University of Michigan](http://www-personal.umich.edu/~mejn/centrality/labeled.png)_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_network_centrality2.png)](/../../../assets/posts/gatech/network_science/L1_network_centrality2.png) _Image Source:[The Measurement Standard, Carma](http://www.themeasurementstandard.com/wp-content/uploads/2016/04/network-of-swords.jpg)_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_communities1.png)](/../../../assets/posts/gatech/network_science/L1_communities1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_network_centrality2.png)](/../../../assets/posts/gatech/network_science/L1_network_centrality2.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_dynamics_of_networks.png)](/../../../assets/posts/gatech/network_science/L1_dynamics_of_networks.png) _The image above shows how the community structure of a network may be changing over time. (Image Source:[The University of Florida](http://www.cise.ufl.edu/~tdinh/)_
...
> **Key Concept:** Networks aren't just physical structures; they also act as conduits for **dynamic processes** like epidemics, **information contagion**, and cascading failures.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_influence_and_cascade_phenomena.png)](/../../../assets/posts/gatech/network_science/L1_influence_and_cascade_phenomena.png) _Image Source:[Bovet, A., Makse, H.A. Influence of fake news in Twitter during the 2016 US presidential election. Nat Commun 10, 7 (2019)](https://www.nature.com/articles/s41467-018-07761-2)_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_ml_and_ns.png)](/../../../assets/posts/gatech/network_science/L1_ml_and_ns.png) _Image Source:[Ganapathiraju, M., Thahir, M., Handen, A. et al. Schizophrenia interactome with 504 novel protein–protein interactions. npj Schizophr 2, 16012 (2016)](https://www.nature.com/articles/npjschz201612)_
...
> **Mental Model:** Real-world networks often exhibit the "**Small-World**" property (short paths between most nodes) and are "Scale-Free" (few hubs hold most connections due to **preferential attachment**).
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_birth_ns1.png)](/../../../assets/posts/gatech/network_science/L1_birth_ns1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L1_birth_ns2.png)](/../../../assets/posts/gatech/network_science/L1_birth_ns2.png)
