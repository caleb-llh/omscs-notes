...
> **Key Concept:** Node embedding maps a graph's nodes to low-dimensional vectors (points in space) such that nodes that are structurally "close" or "similar" in the network are mapped to nearby points. This enables the use of standard machine learning algorithms on graph data.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_embedding.png)](/../../../assets/posts/gatech/network_science/L14_embedding.png) _Images ( a,b ) from Jure Leskovec , “Representation Learning on Networks” tutorial, WWW 2018_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_embedding1.png)](/../../../assets/posts/gatech/network_science/L14_embedding1.png) _Image from:[Perozzi et al. 2014](https://arxiv.org/pdf/1403.6652.pdf). ​DeepWalk: Online Learning of Social Representations. KDD._
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_embedding2.png)](/../../../assets/posts/gatech/network_science/L14_embedding2.png)
...
> **Key Concept:** Shallow encodings learn a unique vector for every node (e.g., using an embedding matrix) to preserve similarities like direct connections or common neighbors. They are computationally expensive and cannot generalize to unseen nodes.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_Shallow.png)](/../../../assets/posts/gatech/network_science/L14_Shallow.png) _Images from Jure Leskovec, “Representation Learning on Networks” tutorial, WWW 2018​_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_Shallow1.png)](/../../../assets/posts/gatech/network_science/L14_Shallow1.png) _Images from Jure Leskovec, “Representation Learning on Networks” tutorial, WWW 2018_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_Shallow2.png)](/../../../assets/posts/gatech/network_science/L14_Shallow2.png) _Images from Jure Leskovec, “Representation Learning on Networks” tutorial, WWW 2018​_
...
> **Mental Model:** Random-walk encodings (like node2vec and DeepWalk) define similarity stochastically: two nodes are similar if they frequently co-occur on short random walks. By tuning the walk parameters (BFS vs DFS), we can capture different notions of neighborhood.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_rw.png)](/../../../assets/posts/gatech/network_science/L14_rw.png) _Images from Jure Leskovec, “Representation Learning on Networks” tutorial, WWW 2018_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_rw1.png)](/../../../assets/posts/gatech/network_science/L14_rw1.png) _Images from Jure Leskovec, “Representation Learning on Networks” tutorial, WWW 2018.​_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_embed.png)](/../../../assets/posts/gatech/network_science/L14_embed.png) _Images from Jure Leskovec, “Representation Learning on Networks” tutorial, WWW 2018​_
...
> **Key Concept:** Graph Neural Networks (GNNs) solve the limitations of shallow embeddings. They share parameters across nodes, incorporate arbitrary node attributes, and have inductive capabilities—meaning they can generalize to unseen nodes or entirely new graphs.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_deep_embed.png)](/../../../assets/posts/gatech/network_science/L14_deep_embed.png) _All images in this page are from Jure Leskovec , “Representation Learning on Networks” tutorial, WWW 2018_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_deep_embed1.png)](/../../../assets/posts/gatech/network_science/L14_deep_embed1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_deep_embed2.png)](/../../../assets/posts/gatech/network_science/L14_deep_embed2.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_deep_embed3.png)](/../../../assets/posts/gatech/network_science/L14_deep_embed3.png)
...
> **Mental Model:** A GNN is trained using an **encoder**-**decoder** architecture. The encoder generates the embeddings, and the decoder maps them to predictions (like class labels or edge probabilities). The loss function forces the shared weights to update in a way that minimizes prediction error.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_gnn.png)](/../../../assets/posts/gatech/network_science/L14_gnn.png) _All images in this page are from Jure Leskovec , “Representation Learning on Networks” tutorial, WWW 2018_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_gnn1.png)](/../../../assets/posts/gatech/network_science/L14_gnn1.png)
...
> **Key Concept:** Complex multimodal graphs, such as drug-gene-protein interaction networks, can be processed by specialized GNNs (like Decagon) to predict side effects that only emerge from specific drug combinations.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_poly.png)](/../../../assets/posts/gatech/network_science/L14_poly.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_poly1.png)](/../../../assets/posts/gatech/network_science/L14_poly1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_poly2.png)](/../../../assets/posts/gatech/network_science/L14_poly2.png)
...
> **Mental Model:** Instead of explicitly defining network rules (like preferential attachment), deep generative models learn a high-dimensional joint distribution from real data. This allows us to synthesize new, realistic networks or molecules that implicitly obey the complex structural properties of the training data.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_advance.png)](/../../../assets/posts/gatech/network_science/L14_advance.png) _Source: “Machine Learning with Graphs” – Jure leskovec http://web.stanford.edu/class/cs224w/​_
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_Interdependent.png)](/../../../assets/posts/gatech/network_science/L14_Interdependent.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_Interdependent1.png)](/../../../assets/posts/gatech/network_science/L14_Interdependent1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_Interdependent2.png)](/../../../assets/posts/gatech/network_science/L14_Interdependent2.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L14_advance1.png)](/../../../assets/posts/gatech/network_science/L14_advance1.png) _Source:[“Temporal network metrics and their application to real world networks”](https://www.cl.cam.ac.uk/~cm542/phds/johntang.pdf) (Figure 4.5) by J.K.Tang._
