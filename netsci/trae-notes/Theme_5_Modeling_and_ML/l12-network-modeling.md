...
> **Mental Model:** A network model is like a blueprint. Instead of relying on a single, specific instance of a real-world network (which might be noisy or incomplete), a model provides a parsimonious description that can generate an ensemble of statistically similar networks to test hypotheses.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_nm.png)](/../../../assets/posts/gatech/network_science/L12_nm.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_nm1.png)](/../../../assets/posts/gatech/network_science/L12_nm1.png)
...
> **Key Concept:** Preferential Attachment is the "rich get richer" phenomenon. New nodes are more likely to connect to existing nodes that already have a high degree, naturally leading to the emergence of hubs and a power-law degree distribution.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_Mathematical.jpeg)](/../../../assets/posts/gatech/network_science/L12_Mathematical.jpeg)
...
> **Key Concept:** The continuous-time approximation simplifies the analysis of the Preferential Attachment model, allowing us to predict that the degree of a node increases sublinearly with time (specifically, with the square root of time).
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_Degree.jpeg)](/../../../assets/posts/gatech/network_science/L12_Degree.jpeg)
...
> **Mental Model:** By changing the exponent $\alpha$ in the preferential attachment probability, we can tune the network from a "stretched exponential" degree distribution ($\alpha < 1$) to a "star topology" ($\alpha > 1$).

[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_Nonlinear.jpeg)](/../../../assets/posts/gatech/network_science/L12_Nonlinear.jpeg)

[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_Nonlinear1.jpeg)](/../../../assets/posts/gatech/network_science/L12_Nonlinear1.jpeg)
...
> **Key Concept:** The Link-Copy Model offers a flexible way to generate power-law networks with an adjustable exponent. It mimics real-world mechanisms like copying web links, citing papers, or duplicating genes.

[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_link.jpeg)](/../../../assets/posts/gatech/network_science/L12_link.jpeg)
...
> **Mental Model:** The Stochastic Block Model (SBM) allows us to create flat, non-hierarchical community structures. It is defined by the number of communities and a probability matrix determining intra- and inter-community connections.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_Community.png)](/../../../assets/posts/gatech/network_science/L12_Community.png)

[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_Community1.jpeg)](/../../../assets/posts/gatech/network_science/L12_Community1.jpeg)

[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_Community2.png)](/../../../assets/posts/gatech/network_science/L12_Community2.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_Correlations.jpeg)](/../../../assets/posts/gatech/network_science/L12_Correlations.jpeg)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_Correlations1.jpeg)](/../../../assets/posts/gatech/network_science/L12_Correlations1.jpeg)
...
> **Key Concept:** Networks in the real world are often formed to optimize a trade-off, such as minimizing connection costs while keeping path lengths short. Varying this trade-off parameter can dramatically shift the topology from a hub-and-spoke model to a decentralized, exponential degree network.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_formation.jpeg)](/../../../assets/posts/gatech/network_science/L12_formation.jpeg)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_formation1.png)](/../../../assets/posts/gatech/network_science/L12_formation1.png)
...
> **Mental Model:** The Hierarchical Random Graph (HRG) model is a powerful tool capable of capturing multiple real-world properties simultaneously: heavy-tailed degree distributions, clustering, community structure, and hierarchical organization. It uses a dendrogram (binary tree) to represent these nested relationships.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_Hierarchical.png)](/../../../assets/posts/gatech/network_science/L12_Hierarchical.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_HRG.png)](/../../../assets/posts/gatech/network_science/L12_HRG.png)
...
> **Key Concept:** Since the number of possible dendrograms is super-exponential, we cannot check them all. Instead, we use Markov Chain Monte Carlo (MCMC) to stochastically search for a dendrogram that maximizes the model likelihood.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_optimal.png)](/../../../assets/posts/gatech/network_science/L12_optimal.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L12_Applications.png)](/../../../assets/posts/gatech/network_science/L12_Applications.png)
