...
> **Key Concept:** When we cannot observe the entire **population graph**, we rely on a **sampled graph**. Different sampling designs (e.g., observing all edges vs. observing only edges between sampled nodes) require different statistical estimators to accurately infer population-level properties.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_sample.jpeg)](/../../../assets/posts/gatech/network_science/L13_sample.jpeg) _Image source: http://www.old-ib.bioninja.com.au/options/option-g-ecology-and-conser/g5-population-ecology.html_
...
> **Mental Model:** There are four common network sampling strategies: **induced subgraph sampling** (random nodes), **incident subgraph sampling** (random edges), **snowball sampling** (BFS from seed nodes), and **link tracing** (paths from sources to targets).

[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Strategies.png)](/../../../assets/posts/gatech/network_science/L13_Strategies.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Strategies1.png)](/../../../assets/posts/gatech/network_science/L13_Strategies1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Strategies2.png)](/../../../assets/posts/gatech/network_science/L13_Strategies2.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Strategies3.png)](/../../../assets/posts/gatech/network_science/L13_Strategies3.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_inclusion.png)](/../../../assets/posts/gatech/network_science/L13_inclusion.png) _Image source: Kolaczyk, Eric D. Statistical Analysis of Network Data: Methods and Models (2009) Springer Science+Business Media LLC._
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_inclusion1.png)](/../../../assets/posts/gatech/network_science/L13_inclusion1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_inclusion2.png)](/../../../assets/posts/gatech/network_science/L13_inclusion2.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_inclusion3.png)](/../../../assets/posts/gatech/network_science/L13_inclusion3.png)
...
> **Key Concept:** The **Horvitz-Thompson estimator** provides an unbiased estimate of population totals by weighting each sampled observation by the inverse of its inclusion probability. This corrects for the bias introduced by the sampling design.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_estimate.png)](/../../../assets/posts/gatech/network_science/L13_estimate.png) _Image source: Kolaczyk, Eric D. Statistical Analysis of Network Data: Methods and Models (2009) Springer Science+Business Media LLC._
...
> **Key Concept:** By dropping a target node from the analysis and checking how often it is observed on paths to other targets, we can extrapolate the unobserved portion of the network and accurately estimate its total size.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_estimate1.png)](/../../../assets/posts/gatech/network_science/L13_estimate1.png) _Image source: Kolaczyk, Eric D. Statistical Analysis of Network Data: Methods and Models (2009) Springer Science+Business Media LLC._
...
> **Mental Model:** Topology inference asks: "How can we guess the full structure of a network when we only see parts of it?" This encompasses link prediction (guessing missing edges), association networks (inferring edges from node similarities), and network tomography (inferring internal structure from peripheral measurements).
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_topology.png)](/../../../assets/posts/gatech/network_science/L13_topology.png) _Image source: Kolaczyk, Eric D. Statistical Analysis of Network Data: Methods and Models (2009) Springer Science+Business Media LLC._
...
> **Key Concept:** Link prediction typically uses a combination of node attributes and topological similarity metrics (like Jaccard or Adamic-Adar similarity) as features in a statistical model (e.g., **Logistic Regression**) to estimate the probability of an unobserved edge existing.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_link.png)](/../../../assets/posts/gatech/network_science/L13_link.png) _Source: “Statistical analysis of network data” by E.D.Kolaczyk. http://math.bu.edu/ness12/ness2012-shortcourse-kolaczyk.pdf_
...
where $Y_{i,j}=1$ means that the edge between nodes i and j actually exists (observed or missing) – while $Y_{i,j}=0$ means that the edge does not exist. The vector z includes all the predictor variables for that node pair (we defined six such variables above). Finally, the vector $\beta$ is the vector of the regression coefficients, and it is assumed to be the same for all node pairs.
...
> **Mental Model:** To build an association network, we first need a similarity metric (like Pearson correlation) between node attributes. Then, we perform hypothesis testing to determine significance, carefully controlling for the **False Discovery Rate** to avoid a flood of spurious edges.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Association.png)](/../../../assets/posts/gatech/network_science/L13_Association.png) _Image source: Kolaczyk, Eric D. Statistical Analysis of Network Data: Methods and Models (2009) Springer Science+Business Media LLC._
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Association1.png)](/../../../assets/posts/gatech/network_science/L13_Association1.png) _Image source: “The power of the Benjamini-Hochberg procedure”, by W. van Loon, http://www.math.leidenuniv.nl/scripties/MastervanLoon.pdf_
...
> **Mental Model:** "**packet sandwiches**" (sending small and large packets together) allow us to measure shared delays. These delays correlate with path overlap, enabling hierarchical clustering to reconstruct the hidden tree-like routing structure.
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Topology1.png)](/../../../assets/posts/gatech/network_science/L13_Topology1.png) _Image source: Kolaczyk, Eric D. Statistical Analysis of Network Data: Methods and Models (2009) Springer Science+Business Media LLC._
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Topology2.png)](/../../../assets/posts/gatech/network_science/L13_Topology2.png) _Image source: Kolaczyk, Eric D. Statistical Analysis of Network Data: Methods and Models (2009) Springer Science+Business Media LLC._
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Topology3.png)](/../../../assets/posts/gatech/network_science/L13_Topology3.png) _Image source: Kolaczyk, Eric D. Statistical Analysis of Network Data: Methods and Models (2009) Springer Science+Business Media LLC._
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Inference.png)](/../../../assets/posts/gatech/network_science/L13_Inference.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Inference1.png)](/../../../assets/posts/gatech/network_science/L13_Inference1.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Inference2.png)](/../../../assets/posts/gatech/network_science/L13_Inference2.png)
...
[![image](https://lowyx.com/assets/posts/gatech/network_science/L13_Inference3.png)](/../../../assets/posts/gatech/network_science/L13_Inference3.png)
